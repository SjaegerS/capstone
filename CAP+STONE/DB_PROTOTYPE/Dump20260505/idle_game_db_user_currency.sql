...
CREATE TABLE `user_currency` (
  ...
  KEY `fk_user_currency_user` (`user_id`),
  CONSTRAINT `fk_user_currency_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `user_currency` VALUES (1,1,1000,10,'2026-05-05 18:05:05');
